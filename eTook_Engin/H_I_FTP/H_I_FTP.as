package eTook_Engin.H_I_FTP {
	...
	public class H_I_FTP {
		public static var LOGIN_SUCCESS = 'loginSuccess';
		public static var DOWNLOAD_SUCCESS = 'downloadSuccess';
		public static var UPLOAD_SUCCESS = 'uploadSuccess';
		public static var CONNECTION_CLOSED = 'connectionClosed';
		public static var CONNECTION_TIMEOUT = 'connectionTimeout';
		public static var LOGIN_FAILD = 'loginFaild';
		public static var DIRECTORY_FAILD = 'directoryFaild';
		public static var UPLOAD_STREAM_SUCCESS = 'uploadStreamSuccess';
		public static var STREAM_CLOSED = 'streamClosed';
		public static var ERROR = 'error';
		public static var DIR_LIST_RECEIVED = 'dirListReceived';
		//
		...
		public function H_I_FTP(host:String = null, username:String = null, password:String = null, port:int = 21):void {
			_host = host;
			_username = username;
			_password = password;
			_port = port;
