		...
		function convertAndBreak(txt,breakLen)
		{
			var strConverted = convertFA (txt);		
			return breakLine(strConverted , breakLen);
		}
		
		function breakLine(txt, breakLen)
		{
			//return txt;
			if (txt.split("\n").length>1)
			{
